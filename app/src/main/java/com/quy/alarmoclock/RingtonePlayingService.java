...
public class RingtonePlayingService extends Service {
    ...
    public void onCreate() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            configNoti();
            Notification notification = new Notification.Builder(this).setContentTitle("ForeGround").setContentText("Work").setSmallIcon(R.drawable.ic_call).setChannelId("10101").build();
